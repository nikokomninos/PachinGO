  ...
  window.DOMElementHandler = class extends self.DOMHandler {
    ...
    _OnUpdatePosition(e) {
      ...
      d !== t.GetHTMLZIndex() &&
        ...
        t.HadFirstUpdate() ||
          (t.SetHadFirstUpdate(), t.GetVisibleFlag() && (n.style.display = ""));
    }
  ...
  window.RuntimeInterface = class n {
    ...
    constructor(e) {
      if (
        ...
        (this.#R = e.exportType),
        ("playable-ad-single-file" !== this.#R &&
          "playable-ad-zip" !== this.#R &&
          "instant-games" !== this.#R) ||
          (this.#e = !1),
        (s || "macos-wkwebview" === this.#R) && (this.#e = !1),
        "cordova" === this.#R && this.#e && t)
      ) {
      ...
      this.IsAnyWebView2Wrapper()
        ? self["chrome"]["webview"].addEventListener("message", (e) =>
            this.#I(e.data, e["additionalObjects"]),
          )
        : "macos-wkwebview" === this.#R
          ? (self["C3WrapperOnMessage"] = (e) => this.#I(JSON.parse(e)))
          : "linux-cef" === this.#R &&
        ...
        "cordova" === this.#R
          ? document.addEventListener("deviceready", () => this.#x(e))
          : this.#x(e),
    ...
    Release() {
      ...
      for (const { canvas: e, htmlWrap: t } of this.#d) e.remove(), t.remove();
      this.#d.length = 0;
    }
    GetMainCanvas() {
    ...
    IsAnyWebView2Wrapper() {
      return this.IsWindowsWebView2() || "xbox-uwp-webview2" === this.#R;
    }
    ...
    *_CanDoAndroidVirtualKeyboardDetection() {
    ...
    async #x(e) {
      ...
      if (
        ...
        window["c3_addPortMessageHandler"] &&
          window["c3_addPortMessageHandler"]((e) => this.#E(e)),
      ...
      this.#e ? await this.#D(e, t.port2) : await this.#F(e, t.port2);
    }
    #U(e) {
      return {
    ...
    async #F(e, t) {
      ...
      const i = await Promise.all(e.runtimeScriptList.map((e) => this.#G(e)));
      ...
      if (a)
        try {
          if (
            (await r(a),
            "preview" === this.#R && !globalThis.C3_ProjectMainScriptOK)
          )
          ...
          this.#V(),
            ...
            alert(
              `Failed to load the project main script (${a}). Check all your JavaScript code has valid syntax, all imports are written correctly, and that an exception was not thrown running the script. Press F12 and check the console for error details.`,
            );
        }
      if (o)
        try {
          if (
            (await r(o),
            "preview" === this.#R && !globalThis.C3.JavaScriptInEvents)
          )
      ...
      if (d)
        try {
          if (
            (await r(d),
            "preview" === this.#R && !globalThis.C3.TypeScriptInEvents)
          )
    ...
    async CreateWorker(e, t) {
      ...
      if ("playable-ad-single-file" === this.#R) {
    ...
    _OnSetHTMLLayerCount(e) {
      ...
      if (t < this.#d.length)
        for (; this.#d.length > t; ) {
          ...
          t.remove(), this.#e && !n ? this.#c.push(e) : e.remove();
        }
      ...
      return (
        this._UpdateHTMLElementsZOrder(), { addedCanvases: l, transferables: d }
      );
    }
    #P(e) {
      for (let t = 0, s = Math.min(this.#d.length, e.length); t < s; ++t) {
        const { htmlWrap: s, lastHtmlLayerDomState: n } = this.#d[t],
          ...
          o = r["isInteractive"];
        i !== n.isVisible &&
          ((s.style.display = i ? "" : "none"), (n.isVisible = i)),
          a !== n.opacity &&
            ((s.style.opacity = 1 === a ? "" : String(a)), (n.opacity = a)),
          o !== n.isInteractive &&
            ((s.style.pointerEvents = o ? "" : "none"),
            o
              ? s.setAttribute("interactive", "")
              : s.removeAttribute("interactive"),
            (n.isInteractive = o));
      }
    }
    #L() {
    ...
    #m() {
      ...
      for (; n < r; ++n) {
        ...
        r.GetActualHTMLIndex() !== t &&
          (this.#z(t, e.slice(s, n)), (t = r.GetActualHTMLIndex()), (s = n));
      }
    ...
    _OnMessageFromRuntime(e) {
      const t = e["type"];
      if ("event" === t) return this.#Z(e);
      if ("result" === t) this.#J(e);
      else if ("runtime-ready" === t) this.#$();
      else if ("alert-error" === t) this.#V(), alert(e["message"]);
      else {
    ...
    #Z(e) {
      ...
      if (!a)
        return void console.warn(
          `[DOM] No handler '${s}' for component '${t}'`,
        );
      let o = null;
      try {
        o = a(n);
        ...
        return (
          console.error(`Exception in '${t}' handler '${s}':`, e),
    ...
    #q(e, t, s) {
      ...
      s && s["transferables"] && (n = s["transferables"]),
        this.#t.postMessage(
          { type: "result", responseId: e, isOk: t, result: s },
          n,
        );
    }
    #J(e) {
      const t = e["responseId"],
        ...
        n = e["result"],
        r = c.get(t);
      s ? r.resolve(n) : r.reject(n), c.delete(t);
    }
    AddRuntimeComponentMessageHandler(e, t, s) {
      let n = d.get(e);
      if ((n || ((n = new Map()), d.set(e, n)), n.has(t)))
    ...
    #X(e) {
      ...
      return new Promise((s, n) =>
        t["checkPermission"](this.#N(t, e), (e) => s(!!e["hasPermission"]), n),
      );
    }
    #Y(e) {
      const t = this.#K();
    ...
    async RequestPermissions(e) {
      ...
      for (const t of e) {
        if (await this.#X(t)) continue;
        if (!1 === (await this.#Y(t))) return !1;
      }
      return !0;
    }
    ...
    #I(e, t) {
      ...
      const s = e["type"];
      if ("directory-handles" === s) this.#C = t;
      else if ("wrapper-init-response" === s) this.#M(e), (this.#M = null);
    ...
    async #Q(e, t) {
      if ("object" == typeof t)
        ...
        s || (s = this.#te(t)), (this._localFileBlobs[e] = s);
      }
    }
    async #ee(e) {
      try {
    ...
    #se(e) {
      ...
      return (
        (l =
          "base64" === a || "base64" === o ? atob(n) : decodeURIComponent(n)),
        { mime_type: i, data: l }
      );
    }
    #ne(e, t) {
  ...
  const _ = "runtime",
    w = class extends self.DOMHandler {
      ...
      Attach() {
        window.addEventListener("focus", () =>
          ...
          window.addEventListener("focusin", (e) => {
            var t;
            (t = e.target),
              (l.has(t.tagName.toLowerCase()) || r(t)) &&
      ...
      _OnKeyEvent(e, t) {
        ...
        if (("Backspace" === t.key && h(t), this._isExportToVideo)) return;
      ...
      async _OnRasterSvgImage(e) {
        const t = e["blob"],
          ...
          o = e["surfaceHeight"],
          a = e["imageBitmapOpts"],
          d = await self["C3_RasterSvgImageBlob"](t, i, n, s, o);
        let r;
        return (
          (r = a ? await createImageBitmap(d, a) : await createImageBitmap(d)),
          { imageBitmap: r, transferables: [r] }
        );
      }
      ...
      return (
        "textarea" === a
          ? ((o = document.createElement("textarea")),
            (o.style.resize = "none"))
          : ((o = document.createElement("input")), (o.type = a)),
        (o.style.position = "absolute"),
        (o.autocomplete = "off"),
        o.addEventListener("pointerdown", t),
        o.addEventListener("pointerrawupdate", t),
        ...
        o.addEventListener("input", () =>
          this.PostToRuntimeElement("change", e, { text: o.value }),
        ),
        s["id"] && (o.id = s["id"]),
        s["className"] && (o.className = s["className"]),
        this.UpdateState(o, s),
        o
      );
    }
    UpdateState(e, t) {
      ...
      const n = t["maxLength"];
      n < 0 ? e.removeAttribute("maxlength") : e.setAttribute("maxlength", n);
    }
    _OnScrollToBottom(e) {
  ...
  const n = class extends self.DOMElementHandler {
    ...
    CreateElement(e, n) {
      ...
      return (
        ...
        s.addEventListener("pointerrawupdate", t),
        ...
        s.addEventListener("change", () =>
          this.PostToRuntimeElement("change", e, {
...
("use strict");
{
  ...
  const s = class extends self.DOMElementHandler {
    constructor(t) {
      super(t, e),
        this.AddDOMElementMessageHandler("click", (e, t) => this._Click(e, t)),
        this.AddDOMElementMessageHandler("clear", (e) => this._Clear(e));
    }
    CreateElement(e, s) {
      ...
      return (
        ...
        n.addEventListener("pointerrawupdate", t),
        ...
        n.addEventListener("change", () =>
          this.PostToRuntimeElement("change", e, {
            files: Array.from(n.files),
          }),
        ),
        s["id"] && (n.id = s["id"]),
        s["className"] && (n.className = s["className"]),
        this.UpdateState(n, s),
        n
      );
    }
    UpdateState(e, t) {
      e.setAttribute("accept", t["accept"]),
        t["isMultiSelect"]
...
self.C3Html5AudioBuffer = class extends self.C3AudioBuffer {
  ...
  IsLoaded() {
    ...
    return (
      e && (this._reachedCanPlayThrough = !0), e || this._reachedCanPlayThrough
    );
  }
  IsLoadedAndDecoded() {
    ...
    (self.C3AudioStereoPanFX = class extends e {
      ...
      SetParam(e, t, i, s) {
        if (((t = Math.min(Math.max(t / 100, -1), 1)), 9 === e))
          (this._params[0] = t), this.SetAudioParam(this._node["pan"], t, i, s);
      }
    }),
